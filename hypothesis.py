...
cutlets_ = pd.read_csv("C:/Users/hp/Desktop/Hypothesis assi/Cutlets.csv") # load File
# here X = "unit a","unit b" 
#  Y = diameter mean

#  removing null and nan value form data
...
labtat_ = pd.read_csv("C:/Users/hp/Desktop/Hypothesis assi/LabTaT.csv")
...
buyer_ratio = pd.read_csv("C:/Users/hp/Desktop/Hypothesis assi/BuyerRatio.csv")
...
cus_ord_form_ = pd.read_csv("C:/Users/hp/Desktop/Hypothesis assi/CustomerOrderform.csv")
###### chi squared  proportions  test for more than 2 popultions
                                              # Ho : all proportions are equal
                                              # Ha: not all proportions are equal 
...
fantaloons_ = pd.read_csv("C:/Users/hp/Desktop/Hypothesis assi/Fantaloons.csv")
